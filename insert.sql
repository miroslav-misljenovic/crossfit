...
INSERT INTO `crossfit`.`Oprema` (`sifra`, `Proizvodjac`, `Naziv`) VALUES (3, 'UnderArmour', 'Tegovi');
INSERT INTO `crossfit`.`Oprema` (`sifra`, `Proizvodjac`, `Naziv`) VALUES (4, 'Adidas', 'Razgibavanje');
INSERT INTO `crossfit`.`Oprema` (`sifra`, `Proizvodjac`, `Naziv`) VALUES (5, 'Adidas', 'Tegovi');
INSERT INTO `crossfit`.`Oprema` (`sifra`, `Proizvodjac`, `Naziv`) VALUES (6, 'Nike', 'Tegovi');
INSERT INTO `crossfit`.`Oprema` (`sifra`, `Proizvodjac`, `Naziv`) VALUES (7, 'UnderArmour', 'Lopte');
